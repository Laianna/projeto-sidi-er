...
tokenizer = AutoTokenizer.from_pretrained('rdenadai/BR_BERTo', do_lower_case = False)
...
def pipeline_bert(name, X_train, y_train, X_valid, y_valid, X_test, y_test): #X_train = [titulos1, titulos2]
    ...
    model = TFAutoModelForSequenceClassification.from_pretrained('rdenadai/BR_BERTo', from_pt = True)
